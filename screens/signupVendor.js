...
function signupVendor(props) {
  ...
  const storelogininfo = async (name, userid, username, email, mobileno, city, zipcode) => {
    try {
    ...
    const signupdata = async () => {
      ...
      const lastsellitemid = 0;
        ...
        fetch(Constant.BASEURL + 'api/Appapi/SignupVendor',{
          method: 'POST',
          headers: {
          ...
          body: formdata
            ...
            response.json().then((datareturn) =>{
              ...
              if(response.status == 200){
                ...
                //       alert("Registered Successfully! The newly generated username/Password would be sent to you!");
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.bottomView}>
                <View style={{padding:40}}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('LoginVendor', {valuedata: valuedata})}>
